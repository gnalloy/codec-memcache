...
- Import path: `gnalloy.org/codec-memcache`
- Repository: `github.com/gnalloy/codec-memcache`
- Default branch: `dev`
- Preview install: `go get gnalloy.org/codec-memcache@dev`
- License: Apache-2.0
...
This repository owns: Memcached binary protocol objects and ASCII codec helpers for Gnalloy pipelines.
